...
<title>客户案例-<?php echo $config['erelcms_title']; ?></title>
...
<div class="inner container">
 ...
 <li><a>洗碗机</a> </li>
	...
	<main class="main">
	<div class="main_top">
		<h1 class="page_title">客户案例</h1>
			<div class="breadcrumb">
			<i class="fas fa-home"></i><a href="/">首页</a>>><a href="case.html">客户案例</a></div>
	</div>
	<div class="products_list">
		<ul>
  
                <li><div class="li_wrap">
...
.pages ul  a{color:#555;display:block;padding:2px 10px;  border: 1px solid #ddd;float: left;margin: 0 5px;margin-bottom:10px;}
